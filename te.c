...
const gattWriteNoRsp_TE9_packet gattWriteNoRsp_TESRCADC_packet_default={
    HCI_PACKETTYPE_COMMAND, //uint8 type;
    GATT_WRITENORESPONSE, //uint16 opCode;
    0x0D, //uint8 dataLength;
    0x0000, //uint16 connHandle;
    TE_GATT_HANDLE, //uint16 handle;
    {0x02,0x07,0x51,0x0d,0x4d,0x01,0xab,0xad,0x00} //uint8 value[9];
};

const gattWriteNoRsp_TE9_packet gattWriteNoRsp_TESRCFM_packet_default={
    HCI_PACKETTYPE_COMMAND, //uint8 type;
    GATT_WRITENORESPONSE, //uint16 opCode;
    0x0D, //uint8 dataLength;
    0x0000, //uint16 connHandle;
    TE_GATT_HANDLE, //uint16 handle;
    {0x02,0x07,0x51,0x0c,0x4d,0x01,0xad,0x8b,0x00} //uint8 value[9];
};
